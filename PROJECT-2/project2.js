...
class MeshDrawer {
	...
	constructor() {
		...
		this.isLightingEn = gl.getUniformLocation(this.prog, 'enableLighting');
		this.lightPostLoc =	gl.getUniformLocation(this.prog, 'lightPos');
		this.ambIntLoc = gl.getUniformLocation(this.prog, 'ambient');
	...
	enableLighting(show) {
		gl.useProgram(this.prog);
		gl.uniform1i(this.isLightingEn, show);
	}
	
	setAmbientLight(ambient) {
		gl.useProgram(this.prog);
		gl.uniform1f(this.ambIntLoc, ambient);		
	}
}
